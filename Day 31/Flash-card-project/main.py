...
try:
    data = pandas.read_csv("/home/amul/Documents/anjela python/Day 31/Flash-card-project/data/words_to_learn.csv")
except FileNotFoundError:
    original_data = pandas.read_csv("/home/amul/Documents/anjela python/Day 31/Flash-card-project/data/french_words.csv")
    print(original_data)
